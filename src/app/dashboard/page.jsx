...
export default function LogbookPage() {
  ...
  const filteredLogs = logs.filter(l => {
    const matchDate = filterDate
      ? new Date(l.logged_at).toLocaleDateString('en-CA') === filterDate
      : true
                  ...
                  {availableServices.map(serviceName => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {price && (
                          <span style={{ fontSize: 11, color: isInCombo && bothSelected ? '#4ade80' : 'var(--blue-glow)', fontWeight: 600, flexShrink: 0, opacity: isInCombo && bothSelected ? 0.6 : 1 }}>
